...
Having the correct values you can use them to control your RC switches with Home Assistant. Install [HACS](https://hacs.xyz/) and this plugin [rpi_rf](https://github.com/markvader/ha-rpi_rf). Then add the following entry to your `configuration.yml`:
